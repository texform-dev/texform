...
mod tests {
    ...
    use crate::transform::{RuleTier, TransformContextBuilder, TransformRule as _, transform_ast};
    ...
    fn rewrites_newline_to_parser_shaped_linebreak_command() {
        ...
        let transform_ctx = TransformContextBuilder::from_tiers(&[RuleTier::Base])
