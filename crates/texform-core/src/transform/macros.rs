        ...
        impl $crate::transform::TransformRule for $rule_ty {
            fn meta(&self) -> &'static $crate::transform::RuleMeta {
                ...
                static META: $crate::transform::RuleMeta = $crate::transform::RuleMeta {
                    ...
                    class: $crate::transform::RuleClass::$class,
                    summary: $summary,
    ...
    (
        ...
        $crate::transform::define_rule!(
            ...
            pub static $static_name: $rule_ty {
                ...
                triggers: &[$($crate::transform::RuleTarget::Command($alias)),+],
    ...
    (
        ...
        $(
            ...
            fn $label() {
                ...
                let transform_ctx = $crate::transform::TransformContextBuilder::from_classes(
                    &[$crate::transform::RuleClass::$class],
                )
                    .only($rule.meta().key)
