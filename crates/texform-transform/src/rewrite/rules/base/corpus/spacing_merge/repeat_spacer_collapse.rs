//! Collapse runs of the same fixed small Spacer command for corpus normalization.
//!
//! ```yaml
...
define_rule! {
    pub static REPEAT_SPACER_COLLAPSE: RepeatSpacerCollapseRule {
        ...
        level: Corpus,
        summary: "Collapse runs of the same fixed small Spacer command for corpus normalization.",
        fidelity: Reading,
